      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            Padding(
              padding: EdgeInsets.fromLTRB(10.0, 10.0, 210.0, 20.0),
              child:Text(
            ...
            Padding(
              padding: EdgeInsets.fromLTRB(10.0, 20.0, 120.0, 20.0),
              child:Text(
            ...
            SizedBox(height: 30.0),
            Padding(
              padding: EdgeInsets.fromLTRB(10.0, 10.0, 175.0, 10.0),
            ...
            SizedBox(height:20.0),
            Padding(
              padding: EdgeInsets.fromLTRB(10.0, 10.0, 220.0, 10.0),
            ...
            Padding(
              padding: EdgeInsets.fromLTRB(5.0, 10.0, 320.0, 10.0),
              child:Text('About',
                style: TextStyle(color: Colors.black,
                  fontSize: 25.0,
                  fontWeight: FontWeight.bold,
